     ...
     // TODO completar y hacer que se vean los nombres de todos los restaurantes en el mapa
        ...
        if (restaurantes != null)
        {
            for (Restaurante restaurante : restaurantes)
            {
                ...
                // Dibuja un círculo rojo en la ubicación del restaurante
                g2d.setColor(Color.RED);
                g2d.fillOval(x - 5, y - 5, 10, 10); // Círculo con radio 5 px

                // Dibuja el nombre del restaurante cerca del círculo
